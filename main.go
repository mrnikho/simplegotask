...
func makeHTML(d *Response) string {
...
//getStuff() handles the crawling. Returns type Response which has our data
func getStuff(d *Response) {
...
func main() {
	...
	//Routine that triggers a crawl every 5 minutes. ticker returns an event on channel ticker.C every duration d
	go func() {
